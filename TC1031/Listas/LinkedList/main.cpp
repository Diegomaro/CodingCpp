...
int main() {
    ...
    while(answer != 8){
        ...
        std::cout << "5. ELiminar dato por búsqueda" << std::endl;
        std::cout << "6. Borrar la lista" << std::endl;
        std::cout << "7. Imprimir la lista" << std::endl;
		...
		if(answer!=8){
			std::cout << "Ingresa cualquier letra para continuar..." << std::endl;
			std::cin.get();
			std::cin.get();
		}
	}
